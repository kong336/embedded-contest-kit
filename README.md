...
- `ti_examples/`: board-level TI starter examples, currently covering MSP430FR2355 and MSPM0G3507 register-level bringup
...
- [docs/ti_sdk_install_guide.md](docs/ti_sdk_install_guide.md)
